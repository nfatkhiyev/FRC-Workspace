...
public class mecanumDrive extends Subsystem {
	...
	private static WPI_TalonSRX FRONT_LEFT_TALON, BACK_LEFT_TALON,  BACK_RIGHT_TALON;
	private static WPI_TalonSRX FRONT_RIGHT_TALON;
    ...
    public void joystickDrive(Joystick stick) {
    	double xVal = Math.pow(stick.getX(), (1) );
    	double yVal = Math.pow(stick.getY(), (1) );
