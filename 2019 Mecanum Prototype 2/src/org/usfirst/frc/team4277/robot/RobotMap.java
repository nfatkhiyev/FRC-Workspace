...
public interface RobotMap {
	...
	*/
	...
	//PrototypeDrive Talons
	public static int FRONT_RIGHT_TALON = 60; //40AMP  -- Talon
	public static int FRONT_LEFT_TALON = 61;  //40AMP  -- Talon
	public static int BACK_RIGHT_TALON = 58;  //40AMP   -- Talon
	public static int BACK_LEFT_TALON = 59;  //40AMP   -- Talon
	...
	//Auto test numbers
	public static double X_DISTANCE = 5.0;
	public static double Y_DISTANCE = 0.0;
